...
% meta-data
\title{First TAC meeting}
\subtitle{Getting up to speed and starting working on \textit{islgen}}
\author{\href{mailto:alessandro.biagiotti@ziti.uni-heidelberg.de}{Alessandro Biagiotti}}
\titlebackground{images/hd}
